      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-text-secondary">
            ...
            <li><a href="#editors" className="hover:text-primary transition-colors">Editores de Documentos</a></li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-text-secondary">
            <li><a href="#about" className="hover:text-primary transition-colors">Acerca de Inled</a></li>
